...
def main():
    ...
    if page == "Income":
        ...
        if upi_income.empty and neft_income.empty and imps_income.empty:
            ...
            st.dataframe(_dataframe_for_display(customer_display), use_container_width=True, hide_index=True)
        ...
        if income_keyword and income_keyword.strip():
            ...
            if len(matches_inc) == 0:
                ...
                st.dataframe(_dataframe_for_display(matches_inc_display[["Date", "Narration", "Amount"]]), use_container_width=True, hide_index=True)
        st.markdown("---")
        ...
        st.dataframe(_dataframe_for_display(income_display), use_container_width=True, hide_index=True)
        return
    ...
    if page == "Expense":
        ...
        if cost_keyword and cost_keyword.strip():
            ...
            if len(matches) == 0:
                ...
                st.dataframe(_dataframe_for_display(matches_display[["Date", "Narration", "Amount"]]), use_container_width=True, hide_index=True)
        st.markdown("---")
        ...
        st.dataframe(_dataframe_for_display(expense_display), use_container_width=True, hide_index=True)
        ...
        st.dataframe(_dataframe_for_display(cost_head_map), use_container_width=True, hide_index=True)
        return
